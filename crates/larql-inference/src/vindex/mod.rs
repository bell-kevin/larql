...
pub use q4k_forward::{
    ...
    predict_q4k_decode_step_direct, predict_q4k_hidden,
    ...
    predict_q4k_metal_with_replaced_head_residual_delta, predict_q4k_prefill,
    predict_q4k_with_ffn, q4k_ffn_forward_layer, q4k_ffn_forward_layer_q8k, remove_layer_tensors,
